...
class PlayState extends MusicBeatState
{
	...
	override public function create()
	{
		...
		switch (curStage)
		{
			...
			case 'day': //Week M
				var skyBG:BGSprite = new BGSprite('sky_day', -1000, -600, 0.9, 0.9);
				skyBG.setGraphicSize(Std.int(skyBG.width * 0.6));
				add(skyBG);

				var cityBG:BGSprite = new BGSprite('city_day', -1000, -600, 0.9, 0.9);
				cityBG.setGraphicSize(Std.int(cityBG.width * 0.6));
				add(cityBG);

				var grassBG:BGSprite = new BGSprite('grass_day', -1000, -600, 0.9, 0.9);
				grassBG.setGraphicSize(Std.int(grassBG.width * 0.6));
				add(grassBG);

			case 'evening': //Week M
				var skyBG:BGSprite = new BGSprite('sky_evening', -1000, -600, 0.9, 0.9);
				skyBG.setGraphicSize(Std.int(skyBG.width * 0.6));
				add(skyBG);

				var cityBG:BGSprite = new BGSprite('city_evening', -1000, -600, 0.9, 0.9);
				cityBG.setGraphicSize(Std.int(cityBG.width * 0.6));
				add(cityBG);

				var grassBG:BGSprite = new BGSprite('grass_evening', -1000, -600, 0.9, 0.9);
				grassBG.setGraphicSize(Std.int(grassBG.width * 0.6));
				add(grassBG);

			case 'night': //Week M
				var skyBG:BGSprite = new BGSprite('sky_night', -1000, -600, 0.9, 0.9);
				skyBG.setGraphicSize(Std.int(skyBG.width * 0.6));
				add(skyBG);

				var cityBG:BGSprite = new BGSprite('city_night', -1000, -600, 0.9, 0.9);
				cityBG.setGraphicSize(Std.int(cityBG.width * 0.6));
				add(cityBG);

				var grassBG:BGSprite = new BGSprite('grass_night', -1000, -600, 0.9, 0.9);
				grassBG.setGraphicSize(Std.int(grassBG.width * 0.6));
				add(grassBG);

			case 'void': //cyberfunk
				GameOverSubstate.characterName = 'joke-bf-dead';

				var voidBG:BGSprite = new BGSprite('cyberfunk_void', -1000, -600, 0.9, 0.9);
				voidBG.setGraphicSize(Std.int(voidBG.width * 0.9));
				add(voidBG);

				if(!ClientPrefs.lowQuality) {
					voidBoppers = new BGSprite('Homies', -150, 250, 0.9, 0.9, ['The Homies']);
					voidBoppers.setGraphicSize(Std.int(voidBoppers.width * 0.4));
					voidBoppers.updateHitbox();
					add(voidBoppers);
				}
		...
		if (isStoryMode && !seenCutscene)
		{
			switch (daSong)
			{
				...
				case 'chill' | 'swag' | 'one-last-time' | 'nighttime':

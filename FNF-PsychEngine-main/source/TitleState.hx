...
class TitleState extends MusicBeatState
{
	...
	function startIntro()
	{
		...
		melPoint = new FlxSprite(0, 0);
		melPoint.frames = Paths.getSparrowAtlas('melTitle');
		melPoint.antialiasing = ClientPrefs.globalAntialiasing;
		melPoint.animation.addByPrefix('bop', 'gfDance', 24);
		melPoint.animation.play('gfDance');
		melPoint.updateHitbox();
